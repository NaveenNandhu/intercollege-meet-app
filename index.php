...
<div class="container mx-auto px-4 py-12">
    ...
    <div class="text-center mb-12">
        <h1 class="text-4xl md:text-5xl font-bold text-indigo-600">
            Inter-College Meet Hub
        </h1>
        <p class="text-lg text-gray-600 mt-4">
            The central place for all inter-collegiate events and competitions.
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
            ...
            <p class="mb-6 text-gray-600">
                Faculty and HODs can manage meets and events.
            </p>

            <!-- FIXED LINK -->
            <a href="/admin/" 
               class="inline-block bg-indigo-600 text-white font-semibold px-6 py-3 rounded-lg hover:bg-indigo-700 transition-colors duration-300">
               Admin Login
            </a>
        </div>
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
            ...
            <p class="mb-6 text-gray-600">
                Browse events, register, and access your QR codes.
            </p>

            <!-- FIXED LINK -->
            <a href="/users/login.php" 
               class="inline-block bg-green-500 text-white font-semibold px-6 py-3 rounded-lg hover:bg-green-600 transition-colors duration-300">
               User Login / Register
            </a>
        </div>
    </div>
    ...
    <div class="text-center mt-12 max-w-4xl mx-auto">
        <div class="bg-white p-8 rounded-lg shadow-lg">
            ...
            <p class="mb-6 text-gray-600">
                See the winners and official standings for all completed events.
            </p>
